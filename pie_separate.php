...
<body>
	<div class="container" align="center"> <!--class container-->
		<div id="canvas-holder" style="width:60%"> <!--ukuran canvas-->
			<h2 style="font-family: cursive;">Grafik Pie Chart 8 Kategori Angka Penderita Covid 19 di 10 Negara</h2> <!--judul-->
		...
		<script>
			...
			var myChart = new Chart(ctx, {
				...
				data: { //fungsi json yaitu mengembalikan json (javascript object notion) dari suatu nilai. Jadi digunakan untuk pertukaran dan penyimpanan data
					labels: <?php echo json_encode($nama_negara); ?>, //label pie chart
					datasets: [{
						label: 'Total Cases', //label dataset
						data: <?php echo json_encode($total_case); ?>, //mengambil data total_case untuk ditampilkan menjadi pie chart
			...
			var myChart = new Chart(ctx, {
				...
				data: { //fungsi json yaitu mengembalikan json (javascript object notion) dari suatu nilai. Jadi digunakan untuk pertukaran dan penyimpanan data
					...
					datasets: [{
						...
						data: <?php echo json_encode($new_case); ?>, //mengambil data new_case untuk ditampilkan menjadi pie chart
						backgroundColor: [ //pengaturan warna untuk background pie chart
						'rgba(223, 255, 0, 0.2)',
						'rgba(255, 191, 0, 0.2)',
						'rgba(255, 127, 80, 0.2)',
			...
			var myChart = new Chart(ctx, {
				...
				data: { //fungsi json yaitu mengembalikan json (javascript object notion) dari suatu nilai. Jadi digunakan untuk pertukaran dan penyimpanan data
					...
					datasets: [{
						...
						data: <?php echo json_encode($total_death); ?>, //mengambil data total_death untuk ditampilkan menjadi pie chart
						backgroundColor: [ //pengaturan warna untuk background pie chart
						'rgba(223, 255, 0, 0.2)',
						'rgba(255, 191, 0, 0.2)',
						'rgba(255, 127, 80, 0.2)',
			...
			var myChart = new Chart(ctx, {
				...
				data: { //fungsi json yaitu mengembalikan json (javascript object notion) dari suatu nilai. Jadi digunakan untuk pertukaran dan penyimpanan data
					...
					datasets: [{
						...
						data: <?php echo json_encode($new_death); ?>, //mengambil data new_death untuk ditampilkan menjadi pie chart
						backgroundColor: [ //pengaturan warna untuk background pie chart
						'rgba(223, 255, 0, 0.2)',
						'rgba(255, 191, 0, 0.2)',
						'rgba(255, 127, 80, 0.2)',
			...
			var myChart = new Chart(ctx, {
				...
				data: { //fungsi json yaitu mengembalikan json (javascript object notion) dari suatu nilai. Jadi digunakan untuk pertukaran dan penyimpanan data
					labels: <?php echo json_encode($nama_negara); ?>, //label pie chart
					datasets: [{
						label: 'Total Recovered', //label dataset
						data: <?php echo json_encode($total_recover); ?>, //mengambil data total_recover untuk ditampilkan menjadi pie chart
						backgroundColor: [ //pengaturan warna untuk background pie chart
						'rgba(223, 255, 0, 0.2)',
						'rgba(255, 191, 0, 0.2)',
						'rgba(255, 127, 80, 0.2)',
			...
			var myChart = new Chart(ctx, {
				...
				data: { //fungsi json yaitu mengembalikan json (javascript object notion) dari suatu nilai. Jadi digunakan untuk pertukaran dan penyimpanan data
					labels: <?php echo json_encode($nama_negara); ?>, //label pie chart
					datasets: [{
						label: 'New Recovered', //label dataset
						data: <?php echo json_encode($new_recover); ?>,//mengambil data new_recover untuk ditampilkan menjadi pie chart
						backgroundColor: [ //pengaturan warna untuk background pie chart
						'rgba(223, 255, 0, 0.2)',
						'rgba(255, 191, 0, 0.2)',
						'rgba(255, 127, 80, 0.2)',
