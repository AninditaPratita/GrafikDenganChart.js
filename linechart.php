...
<head>
    <title> Membuat Grafik Line Chart Menggunakan Chart JS</title><!--Judul HTML-->
...
<body>
    <div class="container" align="center"> <!--class container-->
        <div style="width: 1300px; height: 1300px"> <!--ukuran canvas-->
            <br><div><h2 style="font-family: cursive;"> Grafik Line Chart 8 Kategori Angka Penderita Covid 19 di 10 Negara</h2></div><!--judul--> 
        ...
        <script>
            ...
            var myChart = new Chart(ctx, {type: 'line', //membuat tipe line chart
                data: { //fungsi json yaitu mengembalikan json (javascript object notion) dari suatu nilai. Jadi digunakan untuk pertukaran dan penyimpanan data
                    ...
                    datasets: [{
                        label: 'Total Cases', //memberi label untuk data pada line chart
                    ...
                    {
                        label: 'New Cases', //memberi label untuk data pada line chart
                    ...
                    {
                        label: 'Total Deaths', //memberi label untuk data pada line chart
                    ...
                    {
                        label: 'New Deaths', //memberi label untuk data pada line chart
                    ...
                    {
                        label: 'Total Recovered', //memberi label untuk data pada line chart
                    ...
                    {
                        label: 'New Recovered', //memberi label untuk data pada line chart
